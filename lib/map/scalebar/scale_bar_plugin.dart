...
class ScaleLayer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var displayDistance = distance < 500
        ? '${distance.toStringAsFixed(0)} m'
        : distance.toNauticalMile < 1.0
            ? '${distance.toNauticalMile.toStringAsFixed(1)} nm'
            : '${distance.toNauticalMile.toStringAsFixed(0)} nm';
    double width = (end.x - start.x);

    return Align(
      alignment: scaleLayerOpts.alignment,
      child: Padding(
